...
```{r}
md_senate_contributions <- read_csv("md_senate_contributions.csv") |>
...
write_csv("cleaned_md_senate_contributions.csv")
...
###### Question 4: How can we compare two different jobs in their donations? 
