...
https://datawrapper.dwcdn.net/x56ya/1/
...
md_gov_county <- md_gov_county %>%
  mutate(Total = Cox + Moore + Lashar + Wallace + Harding + `Write-ins`, 
         Wes_Moore_Percentage = (Moore / Total) * 100)
...
This map is much smaller. I just see Maryland now and it has excluded the areas around it that were gray.
...
**Task** Click the "Customize tooltips" button so it expands down. Change {{ fips_code }} to {{ county }} and {{ pctmoore }} to {{ FORMAT(wes_moore_percentage, "00.0%")}} **Answer** Describe the changes from the previous map
Now when we hover we see the county and the percentages
...
**Task** Click the "Proceed" button until you get to the "Publish & Embed" tab, then click "Publish Now". Copy the published URL (like you did for the chart above) and paste it below. **Answer** Put the URL of your map here. https://datawrapper.dwcdn.net/PsPzF/1/
