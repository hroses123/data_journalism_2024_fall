...
**Task** Load the five CSV files. Do they have the same column structure? **Answer** they have the same column structure.
...
**Task** Load the Maryland 2020 county population data **Answer** this is population data
...
**Task** Run the following code to join Maryland population data and the 2020 voter registration data together using the common column county as the key. How many rows are there now? How many *should* there be? **Answer** There are now 24 rows. Yes, because there are 24 counties in Maryland. 
...
**Task** Create a new dataframe with population and voter data joined together. What does the output message below say about the join? **Answer** It says that it is Joining with `by = join_by(COUNTY)`
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Answer** Prince George's: 61%; 78% respectively
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer** This one is Howard county whereas before was PG. PG had the highest percent of Black voters and highest percentage of Dems. Howard has the highest percent of Asian voters (19%) but not the highest percent of dems (52%) 
