...
**Answer** 131,000 obs and 24 rows
...
In the space below, write the data type for the "last_name" column and the "amount" columns (it's in light gray, offset by \< \>). Also offer your best guess as to what the "last_name" column and the "amount" column represent. **Answer**"last_name" is <chr>, "amount" is <dbl> . The last name represents the last names of the people. The amount column represents the amount of money each person gave.
...
**Answer**
I think this code is pulling the dates that people made contributions and the number of contribtuions from that day. Whereas head just showed the top 6. 
...
**Answer**
It changed how the information was displayed. It is now in descending order not the default of ascending. 
...
**Answer** We are now grouping by memo text and amount and not just date. 
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer** We now see the descriptive statistics. 
