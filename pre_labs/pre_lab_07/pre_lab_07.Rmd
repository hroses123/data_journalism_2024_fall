...
Is the difference between Calvert and Montgomery significant? **Answer** Yes, it is around 25,000

Is the difference between Howard and everyone else significant? **Answer** Yes, Howard sits far above everyone but still closest to Calvert
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** Why are there such discrepancies between some of the zips in the top 20? Like for example, why is there one that is below 50,000 and so many above 100,000? What does this tell us about the area? How do these people vote differently based on income? Can we see that?
