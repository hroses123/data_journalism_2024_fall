...
**Answer** I DID UNAF2024-UNAF2022 because those are the unaf voters from each year then I just subtracted them to find the difference. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a bar chart . We did a + instead of a pipe. The counties are scrunched together and they are ordered alphabetically, not by desc etc. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Now we have it in ascending order. The labels are still scrunched. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The information is now horizontal and I can read the labels
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The bars look darker and the background is lighter
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** This one has a blue background and is gray. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** This one has a header and a source and we see net change
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a row for date and a row for total_contributions. This is a normal graph we would make
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a line chart with months and the time that changed
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** We now have more precise dates. It is harder to see
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now the labels are on a diagonal so it is easier to see
