...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** It contains all of the information it had before but with some weird shape stuff that I have never heard about
...
**Task** Run the following code. Describe the output in the space below. **Answer** This looks lkike a map of the precincts in Prince George's with longitude and latitude
...
**Task** Run the following code. Describe the output in the space below. **Answer** I did not get any output, it just told me to add options(tigris_use_cache = TRUE)
...
**Task** Run the following code. Describe the output in the space below. **Answer** We now have information about the state, county, zipcode, names, class, and that same shape information which seems like it might be longtidue and latitude
...
**Task** Run the following code. Describe the output in the space below. **Answer** This just looks like a table of what we have before with the year 2024
...
**Task** Run the following code. Describe the output in the space below. **Answer** It looks like the state of MD divided by counties
...
**Task** Run the following code. Describe the output in the space below. **Answer** This looks like PG precincts but much more detailed and smaller than before
...
**Task** Run the following code. Describe the output in the space below. **Answer** Here we just have all of the information about how people voted, for ex absentee early etc
...
**Task** Run the following code. Describe the output in the space below. **Answer** Here we have the precincts included with how many people showed up to vote for what
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see PG divided into precincts with colors connoting how many eligible voters are in each precinct
...
**Task** Run the following code. Describe the output in the space below. **Answer** Here we see counties and how many people voted for each party
...
**Task** Run the following code. Describe the output in the space below. **Answer** Now I just see the zips with the county and the estimate of how many voters
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see the county with the zip, estimate of voters and the longidude and latitude
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see county and how many people voted per party with total at end
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see county with the population number per county and the longitude and latitude
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see the county, population, number of voters per party and total and longitude and latitude
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see the county, population and longtitude and latitude without duplicates for certain counties
...
**Task** Run the following code. Describe the output in the space below. **Answer** The new information added is the per capita voters per 10,000
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a graph of voters per county per 10,000
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a map of the voters per 10k with much more distinguishing colors
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** I see that in certain areas the votersper 10k are generally similar
...
**Task** Run the following code. Describe the output in the space below. **Answer** I see the voters per 10k for UNA
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Answer** I see that in the middle were generally closer to 1500 but the ends kind are all over the place. Towards borders were all over the place too. 
